...
const Home = ({ homeInfo, experiences, skills, socials, projects }: Props) => {
  return (
    <div className="bg-white scrollbar-thin scrollbar-track-neutral-100/20 scrollbar-thumb-neutral-100/50 bg-gradient-to-b from-[#a7afbd] via-[#a3a7ab] to-[#ebdfc6] h-screen text-[#F1FAEE] snap-y snap-mandatory overflow-y-scroll overflow-x-hidden z-0">
      <Head>
